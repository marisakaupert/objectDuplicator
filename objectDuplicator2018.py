...
class ObjectDuplicator(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.percentageGeneratedLabel = QtWidgets.QLabel("Percentage Generated: ")
        ...
        self.maxRandomizedScaleLineEdit = QtWidgets.QLineEdit("2.0")
        ...
        self.randomizeAllRotationCheckBox = QtWidgets.QCheckBox(
            "Randomize Rotation")
        self.horizontalLayout_8.addWidget(self.randomizeAllRotationCheckBox)

        self.randomizeRotateXCheckBox = QtWidgets.QCheckBox("Randomize X")
        self.horizontalLayout_8.addWidget(self.randomizeRotateXCheckBox)

        self.randomizeRotateYCheckBox = QtWidgets.QCheckBox("Randomize Y")
        self.horizontalLayout_8.addWidget(self.randomizeRotateYCheckBox)

        self.randomizeRotateZCheckBox = QtWidgets.QCheckBox("Randomize Z")
        ...
        self.minRandomizedRotationLabel = QtWidgets.QLabel("Minimum Rotation: ")
        self.horizontalLayout_5.addWidget(self.minRandomizedRotationLabel)

        self.minRandomizedRotationLineEdit = QtWidgets.QLineEdit("0.0")
        self.horizontalLayout_5.addWidget(self.minRandomizedRotationLineEdit)

        self.minRandomizedRotationHorizontalSlider = QtWidgets.QSlider()
        ...
        self.maxRandomizedRotationLabel = QtWidgets.QLabel("Maximum Rotation: ")
        self.horizontalLayout_9.addWidget(self.maxRandomizedRotationLabel)

        self.maxRandomizedRotationLineEdit = QtWidgets.QLineEdit("1.0")
        self.horizontalLayout_9.addWidget(self.maxRandomizedRotationLineEdit)

        self.maxRandomizedRotationHorizontalSlider = QtWidgets.QSlider()
        ...
        self.deleteObjectsPushButton = QtWidgets.QPushButton("Delete Duplicated Objects")
